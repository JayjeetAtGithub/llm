...
int main() {
...

    {
        ...
        size_t nb, d2;
        float* xb = fvecs_read("siftsmall/siftsmall_base.fvecs", &d2, &nb);
...

    {
        ...
        size_t d2;
        xq = fvecs_read("siftsmall/siftsmall_query.fvecs", &d2, &nq);
...

    {
        ...
        size_t nq2;
        int* gt_int = ivecs_read("siftsmall/siftsmall_groundtruth.ivecs", &k, &nq2);
