...
${DISKANN_HOME}/build/apps/utils/compute_groundtruth  --data_type float --dist_fn l2 --base_file ${DISKANN_DATA}/gist/gist_learn.fbin --query_file  ${DISKANN_DATA}/gist/gist_query.fbin --gt_file ${DISKANN_DATA}/gist/gist_groundtruth.ivecs --K 100
